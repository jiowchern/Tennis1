...
namespace Tests
{
    public class Tests
    {
        ...
        public void LoungeSignInTest()
        {
            ...
            var user = new Tennis1.Game.User(binder);
            var lounge = new Tennis1.Game.Lounge();
            int challenge = 0;
            ...
            binder.Lounge.SignUp(new Tennis1.Common.Registration() { Name = "1" , PlayerNumber =  2 });
            binder.Lounge.SignUp(new Tennis1.Common.Registration() { Name = "1", PlayerNumber = 2 });
        ...
        public void MatchJoin2Test()
        {
            ...
            var user1 = new Tennis1.Game.User(binder1);
            user1.Registration = new Tennis1.Common.Registration() { Name = "1", PlayerNumber = 2 };

            var binder2 = new MatchBinder();
            var user2 = new Tennis1.Game.User(binder2);
            user2.Registration = new Tennis1.Common.Registration() { Name = "2", PlayerNumber = 2 };
            var matcher = new Tennis1.Game.Matcher();
        ...
        public void MatchJoin1Test()
        {
            var binder1 = new MatchBinder();
            var user1 = new Tennis1.Game.User(binder1);
            user1.Registration = new Tennis1.Common.Registration() { Name = "1", PlayerNumber = 1 };
        ...
        public void CourtJoinTest()
        {
            ...
            var court = new Tennis1.Game.Court();
            int doneCount = 0;
            court.DoneEvent += (ids) => {
                doneCount++;
            };
            court.Join(new Tennis1.Game.User[] {user1,user2 });
            court.Left(user1.Id);
        ...
        public void CourtPreparationTest()
        {
            ...
            var preparation = new Tennis1.Game.PreparationStage(new Tennis1.Game.User[] { user1, user2 }) ;
            int doneCount = 0;
        ...
        public void CourtPlayExitTest()
        {
            ...
            var play = new Tennis1.Game.PlayStage(new Tennis1.Game.User[] { user1, user2 });
            int doneCount = 0;
            play.DoneOnceEvent += () => {
                doneCount++;
            };
        ...
        public void CourtPlayMoveTest()
        {
            ...
            var moves = new System.Collections.Generic.List<Tennis1.Common.Move>();
