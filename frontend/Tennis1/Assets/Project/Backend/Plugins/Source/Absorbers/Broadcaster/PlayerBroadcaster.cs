...
namespace Tennis1{ 
    ...
    {
        public string Agent;        
        Regulus.Remote.INotifier<Tennis1.Common.IPlayer> _Notifier;
        ...
        private void _ScaneUpdate()
        {
            ...
            if (agent != null)
            {
                _Notifier = agent.Distributor.QueryNotifier<Tennis1.Common.IPlayer>();
        ...
        private void _Unsupply(Tennis1.Common.IPlayer obj)
        {
            UnsupplyEvent.Invoke(obj);
        }

        private void _Supply(Tennis1.Common.IPlayer obj)
        {
            SupplyEvent.Invoke(obj);
        }

        [Serializable]
        public class UnityBroadcastEvent : UnityEvent<Tennis1.Common.IPlayer>{}
