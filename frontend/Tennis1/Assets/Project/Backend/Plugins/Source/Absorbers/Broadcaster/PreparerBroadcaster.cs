...
namespace Tennis1{ 
    public class PreparerBroadcaster : UnityEngine.MonoBehaviour 
    {
        public string Agent;        
        Regulus.Remote.INotifier<Tennis1.Common.IPreparer> _Notifier;

        private readonly Regulus.Utility.StageMachine _Machine;

        public PreparerBroadcaster()
        {
        ...
        private void _ScaneUpdate()
        {
            ...
            if (agent != null)
            {
                _Notifier = agent.Distributor.QueryNotifier<Tennis1.Common.IPreparer>();
        ...
        private void _Unsupply(Tennis1.Common.IPreparer obj)
        {
            UnsupplyEvent.Invoke(obj);
        }

        private void _Supply(Tennis1.Common.IPreparer obj)
        {
            SupplyEvent.Invoke(obj);
        }

        [Serializable]
        public class UnityBroadcastEvent : UnityEvent<Tennis1.Common.IPreparer>{}
