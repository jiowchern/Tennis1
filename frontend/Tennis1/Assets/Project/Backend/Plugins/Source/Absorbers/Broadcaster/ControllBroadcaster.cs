...
namespace Tennis1{ 
    public class ControllBroadcaster : UnityEngine.MonoBehaviour 
    {
        public string Agent;        
        Regulus.Remote.INotifier<Tennis1.Common.IControll> _Notifier;

        private readonly Regulus.Utility.StageMachine _Machine;

        public ControllBroadcaster()
        {
        ...
        private void _ScaneUpdate()
        {
            ...
            if (agent != null)
            {
                _Notifier = agent.Distributor.QueryNotifier<Tennis1.Common.IControll>();
        ...
        private void _Unsupply(Tennis1.Common.IControll obj)
        {
            UnsupplyEvent.Invoke(obj);
        }

        private void _Supply(Tennis1.Common.IControll obj)
        {
            SupplyEvent.Invoke(obj);
        }

        [Serializable]
        public class UnityBroadcastEvent : UnityEvent<Tennis1.Common.IControll>{}
