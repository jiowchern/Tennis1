...
namespace Tennis1{ 
    public class PlaygroundBroadcaster : UnityEngine.MonoBehaviour 
    {
        public string Agent;        
        Regulus.Remote.INotifier<Tennis1.Common.IPlayground> _Notifier;

        private readonly Regulus.Utility.StageMachine _Machine;

        public PlaygroundBroadcaster()
        {
        ...
        private void _ScaneUpdate()
        {
            ...
            if (agent != null)
            {
                _Notifier = agent.Distributor.QueryNotifier<Tennis1.Common.IPlayground>();
        ...
        private void _Unsupply(Tennis1.Common.IPlayground obj)
        {
            UnsupplyEvent.Invoke(obj);
        }

        private void _Supply(Tennis1.Common.IPlayground obj)
        {
            SupplyEvent.Invoke(obj);
        }

        [Serializable]
        public class UnityBroadcastEvent : UnityEvent<Tennis1.Common.IPlayground>{}
